...
```
  ...
  <li>
    After running the app, a GUI will appear. It has the option to choose the currency types. For example, below we choose USD to INR conversion, for an amount= "1 USD":
